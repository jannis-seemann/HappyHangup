...
class OrganizerController {
    ...
    def save(Organizer organizerInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'organizerInstance.label', default: 'Organizer'), organizerInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'organizerInstance.label', default: 'Organizer'), params.id])
                redirect action: "index", method: "GET"
            }
